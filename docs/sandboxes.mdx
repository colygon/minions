...
- **Example vendors:** MacStadium, AWS EC2 Mac, Scaleway Mac (see [Hosting](/infrastructure#cloud-mac-hosting))
...
| Mac-specific workflows? | [Cloud Mac](/infrastructure#cloud-mac-hosting) | Linux sandboxes |
| Want the fastest time-to-market? | [Claude Managed Agents](/approaches#claude-managed-agents) (Layer D) | Layer B sandbox + custom harness |
...
- [Hosting & Execution](/infrastructure) — Full hosting landscape including sandboxes in context
- [Inference](/inference) — LLM providers that produce the code your sandbox runs
- [Patterns](/patterns) — Broader agentic engineering patterns including failure recovery and multi-agent coordination
- [Approaches](/approaches) — Systems like Stripe Minions and OpenAI Symphony that depend on sandbox infrastructure
